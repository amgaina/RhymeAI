    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0 animate-slide-up">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Your AI-Powered Event Host
              </h1>
              <p className="text-lg mb-8 text-primary-foreground/80">
                Transform your events with a customizable AI emcee that speaks
                in your chosen voice, tone, and language. Perfect for
                conferences, presentations, and educational events.
              </p>
                    ...
                    <div className="mt-6 pt-6 border-t border-primary/20">
                      <div className="bg-secondary/50 p-3 rounded-md">
                        <p className="text-primary-foreground italic">
                          "Welcome to the 2025 Tech Innovation Summit! I'm your
                          AI host for today's exciting sessions..."
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-primary-foreground/70 max-w-2xl mx-auto">
              Our AI emcee platform offers everything you need to create a
              professional and engaging event experience.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 stagger-animation">
            <div className="bg-white p-6 rounded-lg shadow-md border border-primary/10 hover-lift animate-fade-in rhyme-card">
              ...
              <p className="text-primary-foreground/70">
                Choose from various accents, tones, and speaking styles to match
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-primary/10 hover-lift animate-fade-in rhyme-card">
              ...
              <p className="text-primary-foreground/70">
                Host your event in multiple languages to accommodate
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-primary/10 hover-lift animate-fade-in rhyme-card">
              ...
              <p className="text-primary-foreground/70">
                Make last-minute changes to your script or schedule and the AI
                will adapt instantly.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-primary/10 hover-lift animate-fade-in rhyme-card">
              ...
              <p className="text-primary-foreground/70">
                Create different AI hosts for various segments of your event
          ...
          <div className="grid md:grid-cols-3 gap-10 stagger-animation">
            ...
            <div className="bg-white dark:bg-muted p-8 rounded-2xl shadow-lg relative group transition-all duration-300 hover:shadow-2xl">
              ...
              <p className="text-sm text-primary-foreground/70 mb-5 leading-relaxed">
                Sign up and create a new event. Add basic details like name,
            ...
            <div className="bg-white dark:bg-muted p-8 rounded-2xl shadow-lg relative group transition-all duration-300 hover:shadow-2xl">
              ...
              <p className="text-sm text-primary-foreground/70 mb-5 leading-relaxed">
                Select voice characteristics, speaking style, and language
                preferences for your AI emcee.
              </p>
              <div className="flex justify-center">
                <img
            ...
            <div className="bg-white dark:bg-muted p-8 rounded-2xl shadow-lg relative group transition-all duration-300 hover:shadow-2xl">
              ...
              <p className="text-sm text-primary-foreground/70 mb-5 leading-relaxed">
                Upload or type your script, including announcements,
      ...
      <section id="pricing" className="py-20 bg-secondary rhyme-section">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-primary-foreground/70 max-w-2xl mx-auto">
              Choose the plan that works best for your event needs. All plans
              include our core AI emcee features.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto stagger-animation">
            <div className="bg-white p-8 rounded-lg shadow-md border border-primary/10 hover-lift transition-shadow rhyme-card animate-fade-in">
              <div className="text-center mb-6">
                ...
                <p className="text-primary-foreground/70">
                  Perfect for small events and presentations
                </p>
              </div>
            ...
            <div className="bg-accent p-8 rounded-lg shadow-xl transform md:scale-105 relative rhyme-card animate-fade-in">
              ...
              <Button className="w-full bg-cta hover:bg-cta/90 text-white rhyme-button">
                Choose Professional
              </Button>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md border border-primary/10 hover-lift transition-shadow rhyme-card animate-fade-in">
              <div className="text-center mb-6">
                ...
                <p className="text-primary-foreground/70">
                  For large-scale events and productions
                </p>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 stagger-animation">
            <div className="bg-white p-8 rounded-lg shadow-md rhyme-card animate-fade-in">
              ...
              <p className="text-primary-foreground/70 mb-6 italic">
                "The AI emcee was a game-changer for our tech conference. It
                handled announcements flawlessly and adapted to our last-minute
                schedule changes without any issues."
              </p>
              <div className="flex items-center">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md rhyme-card animate-fade-in">
              ...
              <p className="text-primary-foreground/70 mb-6 italic">
                "Our university graduation ceremony needed to be multilingual,
                and the AI emcee handled English, Spanish, and Mandarin
                announcements perfectly. Parents were impressed!"
              </p>
              <div className="flex items-center">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md rhyme-card animate-fade-in">
              ...
              <p className="text-primary-foreground/70 mb-6 italic">
                "As a small business, we couldn't afford a professional emcee
                for our product launch. The AI host was affordable and sounded
                completely natural. Our audience loved it!"
              </p>
              <div className="flex items-center">
      ...
      <section className="py-20 bg-primary text-primary-foreground rhyme-section rhyme-hero">
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            Join hundreds of organizations already using our AI emcee platform
            to create professional, engaging events.
          </p>
          <div
      ...
      <footer className="bg-primary-foreground text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-white/70 mb-4">
                Transform your events with our AI-powered emcee platform.
                Professional, customizable, and cost-effective.
              </p>
          ...
          <div className="border-t border-white/20 mt-12 pt-8 text-center text-white/70">
            <p>
              &copy; {new Date().getFullYear()} RhymeAI. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
