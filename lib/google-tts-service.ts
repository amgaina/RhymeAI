 ...
 */
export async function generateGoogleTTS(ssml: string, voiceId: string): Promise<Buffer> {
  const client = initializeClient();
  
  if (!client) {
    // Return a mock audio buffer if client initialization failed
    console.warn('Using mock audio data due to missing Google Cloud TTS client');
...
function getMockVoices() {
  return [
    { id: "en-US-Neural2-A", name: "Matthew", gender: "male", language: "en-US" },
    { id: "en-US-Neural2-C", name: "Emma", gender: "female", language: "en-US" },
    { id: "en-US-Neural2-D", name: "Brian", gender: "male", language: "en-US" },
    { id: "en-US-Neural2-E", name: "Olivia", gender: "female", language: "en-US" },
    { id: "en-US-Neural2-F", name: "James", gender: "male", language: "en-US" },
    { id: "en-GB-Neural2-A", name: "Arthur", gender: "male", language: "en-GB" },
    { id: "en-GB-Neural2-C", name: "Charlotte", gender: "female", language: "en-GB" },
    { id: "en-AU-Neural2-A", name: "Noah", gender: "male", language: "en-AU" },
    { id: "en-AU-Neural2-B", name: "Isla", gender: "female", language: "en-AU" },
  ];
}
...
export async function getBestGoogleVoiceMatch(params: {
  ...
  if (params.accent) {
    ...
    const languageCode = accentMap[params.accent as keyof typeof accentMap] || "en-US";
